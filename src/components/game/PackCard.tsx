  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border bg-gradient-to-br from-blue-900/50 via-slate-900/60 to-black/70",
        ...
        selected ? "border-neon glow-ring animate-pulse-neon" : "border-white/10 hover:border-neon/60",
      )}
    >
      ...
      <div className="relative flex flex-col items-center justify-between h-full">
        <div className="w-full flex items-center justify-between">
          ...
          <span className="text-[10px] tracking-[0.3em] uppercase text-neon">{t("pack.squad")}</span>
        </div>

        <div className={cn("relative animate-pack-float", size === "lg" ? "size-24" : "size-12")}>
          <div className="absolute inset-0 rounded-full bg-gradient-to-br from-neon/40 to-transparent blur-xl" />
          <svg viewBox="0 0 100 100" className="relative w-full h-full text-neon drop-shadow-[0_0_20px_currentColor]">
            ...
            <path
              d="M50 25 L50 10 M62 34 L75 30 M57 48 L70 58 M43 48 L30 58 M38 34 L25 30"
        ...
        <div className="text-center">
          ...
          <div className="text-[10px] text-muted-foreground mt-1">{t("pack.hidden11")}</div>
        </div>
      </div>
    </button>
  );
